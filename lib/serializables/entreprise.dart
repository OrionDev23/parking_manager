...
class Entreprise extends Prestataire{
  ...
  String? logo;
  Entreprise({required super.id, required super.nom, required super.adresse,super.art,super.createdAt,super.description,super.email,super.nif,super.nis,super.rc,super.search,super.telephone,super.updatedAt,this.logo});
