...
class DocumentChauffeur extends ParcOtoDefault {
  @JsonKey(
      name: "date_expiration", fromJson: dateFromIntJson, toJson: dateToIntJson)
  ...
  factory DocumentChauffeur.fromJson(Map<String, dynamic> json) =>
      _$DocumentChauffeurFromJson(json);
