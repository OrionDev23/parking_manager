...
import 'gestion_chauf_documents.dart';

class CDocumentTabs extends StatefulWidget {
  const CDocumentTabs({super.key});

  @override
  CDocumentTabsState createState() => CDocumentTabsState();
}
