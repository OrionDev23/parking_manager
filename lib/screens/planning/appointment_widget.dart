      ...
      return f.Column(
        children: [
          Container(
            ...
            color: ColorManipulation.lighten(ColorManipulation.lighten(planning
                .color??appTheme
                .color),),

            child: Center(
                child: Image.asset('assets/images/planning/${planning.type}'
                    '.webp',fit: BoxFit.fitHeight,color: appTheme.fillColor),
                ),
              ),
          Container(
            width: details.bounds.width,
            ...
            color: ColorManipulation.lighten(ColorManipulation.lighten(planning
                .color??appTheme
                .color),),            padding: const EdgeInsets.symmetric(horizontal: 2,vertical: 0.5),
