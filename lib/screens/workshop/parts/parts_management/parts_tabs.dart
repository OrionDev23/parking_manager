...
import 'package:parc_oto/screens/workshop/parts/parts_management/parts_manager.dart';

import 'parts_form.dart';

class PartsTabs extends StatefulWidget {
  final bool archive;
  const PartsTabs({super.key,this.archive=false});

  @override
  State<PartsTabs> createState() => PartTabsState();
}

class PartTabsState extends State<PartsTabs> {
