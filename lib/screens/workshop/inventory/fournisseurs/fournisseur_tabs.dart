...
import 'fournisseur_gestion.dart';

class FournisseurTabs extends StatefulWidget {
  final bool archive;

  const FournisseurTabs({super.key, this.archive = false});

  @override
  FournisseurTabsState createState() => FournisseurTabsState();
}

class FournisseurTabsState extends State<FournisseurTabs> {
