...
class _ReparationFormState extends State<ReparationForm> {
  ...
  Widget build(BuildContext context) {
    ...
    child: ListView(
        ...
        children: [
          entrepriseAndNumOrdre(appTheme),
          Row(
  ...
  Row entrepriseAndNumOrdre(AppTheme appTheme) {
    return Row(
            children: [
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Button(onPressed: ()=> selectAllEntretien(false), child: const Text('clear').tr()),
                  smallSpace,
                  FilledButton(onPressed:()=> selectAllEntretien(true), child: const Text('selectall').tr()),
