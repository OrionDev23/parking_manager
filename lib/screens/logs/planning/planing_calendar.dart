...
class PlanningCalendar extends StatefulWidget {
  ...
  const PlanningCalendar({super.key, required this.controller, required this.datasource,this.toDo});
...
class _PlanningCalendarState extends State<PlanningCalendar> {
  ...
  List<CalendarView> views=const [CalendarView.month,CalendarView.timelineMonth,CalendarView.schedule];
  ...
  Widget build(BuildContext context) {
    ...
    return SfCalendar(
      ...
      onTap: widget.toDo,
      appointmentBuilder: (c,d)=>AppointmentWidget(calendarController:widget.controller,details: d,),
